...
\caption[Distribuzione dell'\textit{in-degree} per gli utenti]{Distribuzione dell'\textit{in-degree} per gli utenti}
\label{fig:in-degree}
\end{figure}
